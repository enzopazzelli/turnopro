...
-- Tabla de archivos
CREATE TABLE public.archivos_pacientes (
...
-- Indices
CREATE INDEX idx_archivos_pacientes_tenant ON public.archivos_pacientes(tenant_id);
CREATE INDEX idx_archivos_pacientes_paciente ON public.archivos_pacientes(paciente_id);
